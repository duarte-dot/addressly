...
public record UserPatchDTO(
    ...
    @Pattern(regexp = "\\d{11}", message = "O CPF deve conter exatamente 11 dígitos") String cpf,
    @Pattern(regexp = "\\d{8}", message = "O CEP deve conter exatamente 8 dígitos") String cep,
